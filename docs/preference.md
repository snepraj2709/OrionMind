...
6. don't use too much margin and padding to create unnecessary whitespaces
7. don't use cards and shadow efffects, the cards that are there in design system are the only approved cards, refrain from using any other form of card

# preferred rules for Code

1. Keep the code modular and reusable
2. follow the best coding practices for structure of the code
3. Write decoupled components and functions
